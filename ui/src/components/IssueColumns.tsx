...
export function IssueColumnPicker({
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-[300px] rounded-none border-border/70 p-1.5 shadow-xl shadow-black/10">
        ...
        {availableColumns.map((column) => (
          <DropdownMenuCheckboxItem
            ...
            className="items-start rounded-none px-3 py-2.5 pl-8"
          >
